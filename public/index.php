...
<body>
  ...
  <header id="header">
    <div class="container">
      ...
      <h1><a href="index.html">Derrick Devin Lim</a></h1>
      <!-- Uncomment below if you prefer to use an image logo -->
      <!-- <a href="index.html" class="mr-auto"><img src="assets/img/logo.png" alt="" class="img-fluid"></a> -->
      <h2>I'm a <span>college student</span> from UPH Medan</h2>
          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              <ul>
                ...
                <li><i class="bi bi-chevron-right"></i> <strong>Email:</strong> <span>03081200023@student.uph.edu</span></li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-6">
          ...
          <div class="resume-item pb-0">
            ...
            <ul>
              ...
              <li>08123456789</li>
              <li>03081200023@student.uph.edu</li>
            </ul>
            </p>
          </div>
      ...
      <div class="row mt-2">
        ...
        <div class="col-md-6 mt-4 mt-md-0 d-flex align-items-stretch">
          <div class="info-box">
            ...
            <h3>Email Me</h3>
            <p>03081200023@student.uph.edu</p>
          </div>
        </div>
